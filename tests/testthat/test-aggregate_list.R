...
test_that("step_aggregate_list() works", {
  ...
  expect_equal(colnames(baked2), c(colnames(cheese_abundance), names(rk_list)))
...
test_that("`others` argument works", {
  ...
  l1 <- list(
    petal.size = c("Petal.Width", "Petal.Length"),
  ...
  expect_equal(
    colnames(bake(rec1_discori, new_data = NULL)),
    c("Species", names(l1))
  )

  expect_equal(tidy(rec1_discori, 1)$terms, colnames(iris)[-5])
  expect_equal(
    tidy(rec1_discori, 1)$aggregate,
  ...
  expect_equal(
    colnames(bake(rec1_keepori, new_data = NULL)),
    c(colnames(iris), names(l1))
  )

  expect_equal(tidy(rec1_keepori, 1)$terms, colnames(iris)[-5])
  expect_equal(
    tidy(rec1_keepori, 1)$aggregate,
    c("sepal.size", "sepal.size", "petal.size", "petal.size")
  )

  ### One variable is missing in list_agg
  l2 <- list(
    petal.size = c("Petal.Length"),
  ...
  expect_equal(
    colnames(bake(rec2_discoth_disori, new_data = NULL)),
    c("Species", names(l2))
  )

  expect_equal(tidy(rec2_discoth_disori, 1)$terms, colnames(iris)[-5])
  expect_equal(
    tidy(rec2_discoth_disori, 1)$aggregate,
  ...
  expect_equal(
    colnames(bake(rec2_discoth_keepori, new_data = NULL)),
    c(colnames(iris), names(l2))
  )

  expect_equal(tidy(rec2_discoth_keepori, 1)$terms, colnames(iris)[-5])
  expect_equal(
    tidy(rec2_discoth_keepori, 1)$aggregate,
    c("sepal.size", "sepal.size", "petal.size", NA)
  )
  ...
  expect_equal(
    colnames(bake(rec2_keepoth_disori, new_data = NULL)),
    c("Petal.Width", "Species", names(l2))
  )

  expect_equal(tidy(rec2_keepoth_disori, 1)$terms, colnames(iris)[-5])
  expect_equal(
    tidy(rec2_keepoth_disori, 1)$aggregate,
  ...
  expect_equal(
    colnames(bake(rec2_keepoth_keepori, new_data = NULL)),
    c(names(iris), names(l2))
  )

  expect_equal(tidy(rec2_keepoth_keepori, 1)$terms, colnames(iris)[-5])
  expect_equal(
    tidy(rec2_keepoth_keepori, 1)$aggregate,
    c("sepal.size", "sepal.size", "petal.size", "Petal.Width")
  )
  ...
  expect_equal(
    colnames(bake(rec3_aggoth_disori, new_data = NULL)),
    c("Species", names(l3), "Oth")
  )

  expect_equal(tidy(rec3_aggoth_disori, 1)$terms, colnames(iris)[-5])
  expect_equal(
    tidy(rec3_aggoth_disori, 1)$aggregate,
    c("sepal.size", "sepal.size", "Oth", "Oth")
  )

  expect_equal(
    bake(rec3_aggoth_disori, new_data = NULL)$Oth,
  ...
  expect_equal(
    colnames(bake(rec3_aggcoth_keepori, new_data = NULL)),
    c(colnames(iris), names(l3), "Oth")
  )

  expect_equal(tidy(rec3_aggcoth_keepori, 1)$terms, colnames(iris)[-5])
  expect_equal(
    tidy(rec3_aggcoth_keepori, 1)$aggregate,
    c("sepal.size", "sepal.size", "Oth", "Oth")
  )

  expect_equal(
    bake(rec3_aggcoth_keepori, new_data = NULL)$Oth,
    iris$Petal.Length * iris$Petal.Width
  )
})
